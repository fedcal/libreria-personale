...
public class DateParserUtil {
    ...
    static {
        ...
        DATE_FORMATTERS.add(DateTimeFormatter.ofPattern("EEE MMM dd HH:mm:ss z yyyy", Locale.ENGLISH)); // Tue Sep 29 19:42:16 CEST 2020
        DATE_FORMATTERS.add(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss", Locale.ITALIAN)); // 29/09/2020 19:42:16
    ...
    /**
     * Prova a convertire una stringa di data in Instant.
     * Supporta diversi formati configurati.
     */
